...
CREATE INDEX idx_retweets_tweet_id ON public.retweets(tweet_id);
CREATE INDEX idx_retweets_user_id ON public.retweets(user_id);
...
CREATE OR REPLACE FUNCTION get_retweets_count(tweet_row public.tweets)
RETURNS BIGINT AS $$
    SELECT COUNT(*)
